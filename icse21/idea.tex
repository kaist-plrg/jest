...
For example, the JavaScrpt code in Figure~\ref{fig:example-js} causes the above
...
based statistical fault localization} (CBSFL)~\cite{cbsfl}.  It uses coverage
