\begin{abstract}
  ...
  In this paper, we propose a novel \textit{$N$+1-version testing} to resolve
  ...
  states, and 3) to find and localize specification bugs via executing
  programs on multiple implementations.  We actualize our approach for
  the JavaScript programming language via \( \tool \), which performs
  $N$+1-version testing for modern JavaScript engines and ECMAScript,
  ...
  it detected \inred{XX} engine bugs in four different engines and \inred{X}
