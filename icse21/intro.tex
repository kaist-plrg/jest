...
\begin{itemize}
  ...
  \item Implement $N$+1-version differential testing for JavaScript engines and
    ...
    of Test262, the official conformance tests, is \inred{--.--}\% for statements
    and \inred{--.--}\% for branches, the coverage of the conformance tests generated by the tool
    is \inred{--.--}\% for statements and \inred{--.--}\% for branches.
  \item Evaluate $\tool$ with four modern JavaScript engines and the latest
    ECMAScript, ES11.  Using the generated conformance test
    suite, the tool found and localized \inred{XX} engine bugs in four different
