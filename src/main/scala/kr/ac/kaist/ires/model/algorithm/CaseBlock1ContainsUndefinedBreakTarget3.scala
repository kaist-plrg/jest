...
object CaseBlock1ContainsUndefinedBreakTarget3 extends Algorithm {
  val name: String = "CaseBlock1ContainsUndefinedBreakTarget3"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""CaseBlock1ContainsUndefinedBreakTarget3" (this, CaseClauses0, DefaultClause, CaseClauses1, labelSet) => {
