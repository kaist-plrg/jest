...
object GLOBALDOTCreateAsyncFromSyncIterator extends Algorithm {
  val name: String = "GLOBALDOTCreateAsyncFromSyncIterator"
  val length: Int = 1
  val lang: Boolean = false
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.CreateAsyncFromSyncIterator" (this, argumentsList, NewTarget) => {
