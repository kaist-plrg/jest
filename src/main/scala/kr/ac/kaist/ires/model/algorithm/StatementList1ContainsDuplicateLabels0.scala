...
object StatementList1ContainsDuplicateLabels0 extends Algorithm {
  val name: String = "StatementList1ContainsDuplicateLabels0"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""StatementList1ContainsDuplicateLabels0" (this, StatementList, StatementListItem, labelSet) => {
