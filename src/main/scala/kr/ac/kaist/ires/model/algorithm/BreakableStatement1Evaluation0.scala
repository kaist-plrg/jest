...
object BreakableStatement1Evaluation0 {
  val length: Int = 0
  val func: Func = Func("""BreakableStatement1Evaluation0""", List(Id("""this"""), Id("""SwitchStatement""")), None, ISeq(List(ILet(Id("""newLabelSet"""), EList(List())), IAccess(Id("""__x0__"""), ERef(RefId(Id("""this"""))), EStr("""LabelledEvaluation""")), IApp(Id("""__x1__"""), ERef(RefId(Id("""__x0__"""))), List(ERef(RefId(Id("""newLabelSet"""))))), IApp(Id("""__x2__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""__x1__"""))))), IReturn(ERef(RefId(Id("""__x2__""")))))))
  /* Beautified form:
