...
object ModuleNamespaceExoticObjectDOTOwnPropertyKeys {
  val length: Int = 0
  val func: Func = Func("""ModuleNamespaceExoticObject.OwnPropertyKeys""", List(Id("""O""")), None, ISeq(List(ILet(Id("""exports"""), ECopy(ERef(RefProp(RefId(Id("""O""")), EStr("""Exports"""))))), IApp(Id("""__x0__"""), ERef(RefId(Id("""OrdinaryOwnPropertyKeys"""))), List(ERef(RefId(Id("""O"""))))), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x0__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x0__""")), ERef(RefProp(RefId(Id("""__x0__""")), EStr("""Value""")))), IReturn(ERef(RefId(Id("""__x0__"""))))), ISeq(List())), ILet(Id("""symbolKeys"""), ERef(RefId(Id("""__x0__""")))), IExpr(ENotSupported("""Etc""")), IApp(Id("""__x1__"""), ERef(RefId(Id("""WrapCompletion"""))), List(ERef(RefId(Id("""exports"""))))), IReturn(ERef(RefId(Id("""__x1__""")))))))
  /* Beautified form:
