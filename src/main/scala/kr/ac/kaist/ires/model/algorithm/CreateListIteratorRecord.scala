...
object CreateListIteratorRecord {
  val length: Int = 1
  val func: Func = Func("""CreateListIteratorRecord""", List(Id("""list""")), None, ISeq(List(IApp(Id("""__x0__"""), ERef(RefId(Id("""ObjectCreate"""))), List(ERef(RefId(Id("""INTRINSIC_IteratorPrototype"""))), EList(List(EStr("""IteratedList"""), EStr("""ListIteratorNextIndex"""))))), ILet(Id("""iterator"""), ERef(RefId(Id("""__x0__""")))), IAssign(RefProp(RefId(Id("""iterator""")), EStr("""IteratedList""")), ERef(RefId(Id("""list""")))), IAssign(RefProp(RefId(Id("""iterator""")), EStr("""ListIteratorNextIndex""")), EINum(0L)), ILet(Id("""steps"""), EMap(Ty("""algorithm"""), List((EStr("""name"""), EStr("""next""")), (EStr("""length"""), EINum(0L)), (EStr("""step"""), ERef(RefId(Id("""ListIteratornext"""))))))), IApp(Id("""__x1__"""), ERef(RefId(Id("""CreateBuiltinFunction"""))), List(ERef(RefId(Id("""steps"""))), EList(List()))), IIf(EBOp(OEq, ETypeOf(ERef(RefId(Id("""__x1__""")))), EStr("""Completion""")), IIf(EBOp(OEq, ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Type"""))), ERef(RefId(Id("""CONST_normal""")))), IAssign(RefId(Id("""__x1__""")), ERef(RefProp(RefId(Id("""__x1__""")), EStr("""Value""")))), IReturn(ERef(RefId(Id("""__x1__"""))))), ISeq(List())), ILet(Id("""next"""), ERef(RefId(Id("""__x1__""")))), IApp(Id("""__x2__"""), ERef(RefId(Id("""WrapCompletion"""))), List(EMap(Ty("""Record"""), List((EStr("""Iterator"""), ERef(RefId(Id("""iterator""")))), (EStr("""NextMethod"""), ERef(RefId(Id("""next""")))), (EStr("""Done"""), EBool(false)))))), IReturn(ERef(RefId(Id("""__x2__""")))))))
  /* Beautified form:
