...
object GLOBALDOTPromiseReactionJob extends Algorithm {
  val name: String = "GLOBALDOTPromiseReactionJob"
  val length: Int = 2
  val lang: Boolean = false
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.PromiseReactionJob" (this, argumentsList, NewTarget) => {
