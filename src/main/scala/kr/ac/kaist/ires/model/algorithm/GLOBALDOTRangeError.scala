...
object GLOBALDOTRangeError extends Algorithm {
  ...
  val func: Func = parseFunc(""""GLOBAL.RangeError" (this, argumentsList, NewTarget) => {
    app __x0__ = (GetArgument argumentsList 0i)
    let message = __x0__
    if (= NewTarget undefined) let newTarget = GLOBAL_context["Function"] else let newTarget = NewTarget
    app __x1__ = (OrdinaryCreateFromConstructor newTarget INTRINSIC_RangeErrorPrototype (new ["ErrorData"]))
