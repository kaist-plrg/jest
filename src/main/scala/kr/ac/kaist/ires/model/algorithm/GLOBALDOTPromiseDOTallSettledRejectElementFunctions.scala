...
object GLOBALDOTPromiseDOTallSettledRejectElementFunctions {
  val length: Int = 0
  val func: Func = parseFunc(""""GLOBAL.Promise.allSettledRejectElementFunctions" (this, argumentsList, NewTarget) => {
    ...
    let obj = __x1__
    app __x2__ = (CreateDataPropertyOrThrow obj "status" "rejected")
    if (is-completion __x2__) if (= __x2__["Type"] CONST_normal) __x2__ = __x2__["Value"] else return __x2__ else {}
    __x2__
    app __x3__ = (CreateDataPropertyOrThrow obj "reason" x)
