...
object EqualityExpression4Evaluation0 {
  ...
  "EqualityExpression4Evaluation0" (this, EqualityExpression, RelationalExpression) => {
    ...
    let r = __x4__
    assert (&& (= (typeof r) "Completion") (= r["Type"] CONST_normal))
    if (= r["Value"] true) {
