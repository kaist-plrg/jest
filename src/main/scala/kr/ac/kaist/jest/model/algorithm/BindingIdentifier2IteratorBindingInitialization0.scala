...
object BindingIdentifier2IteratorBindingInitialization0 extends Algorithm {
  val name: String = "BindingIdentifier2IteratorBindingInitialization0"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""BindingIdentifier2IteratorBindingInitialization0" (BindingIdentifier, iteratorRecord, environment) => {
