...
object GLOBALDOTPromiseDOTallSettledResolveElementFunctions extends Algorithm {
  val name: String = "GLOBALDOTPromiseDOTallSettledResolveElementFunctions"
  val length: Int = 0
  ...
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.Promise.allSettledResolveElementFunctions" (this, argumentsList, NewTarget) => {
    ...
    __x1__
    app __x2__ = (CreateDataPropertyOrThrow obj "value" x)
