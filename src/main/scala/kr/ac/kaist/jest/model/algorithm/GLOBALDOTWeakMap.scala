...
object GLOBALDOTWeakMap extends Algorithm {
  val name: String = "GLOBALDOTWeakMap"
  val length: Int = 0
  val lang: Boolean = false
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.WeakMap" (this, argumentsList, NewTarget) => {
