...
object GLOBALDOTSet extends Algorithm {
  val name: String = "GLOBALDOTSet"
  val length: Int = 0
  val lang: Boolean = false
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.Set" (this, argumentsList, NewTarget) => {
    ...
    app __x2__ = (OrdinaryCreateFromConstructor NewTarget "%Set.prototype%" (new ["SetData"]))
