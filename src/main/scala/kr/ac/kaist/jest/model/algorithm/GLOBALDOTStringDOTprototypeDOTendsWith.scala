...
object GLOBALDOTStringDOTprototypeDOTendsWith extends Algorithm {
  val name: String = "GLOBALDOTStringDOTprototypeDOTendsWith"
  val length: Int = 1
  val lang: Boolean = false
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.String.prototype.endsWith" (this, argumentsList, NewTarget) => {
