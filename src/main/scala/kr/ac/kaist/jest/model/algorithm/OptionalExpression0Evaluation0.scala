...
object OptionalExpression0Evaluation0 extends Algorithm {
  val name: String = "OptionalExpression0Evaluation0"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""OptionalExpression0Evaluation0" (this, MemberExpression, OptionalChain) => {
