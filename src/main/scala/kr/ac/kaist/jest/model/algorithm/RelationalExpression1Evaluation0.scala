...
object RelationalExpression1Evaluation0 extends Algorithm {
  val name: String = "RelationalExpression1Evaluation0"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""RelationalExpression1Evaluation0" (this, RelationalExpression, ShiftExpression) => {
