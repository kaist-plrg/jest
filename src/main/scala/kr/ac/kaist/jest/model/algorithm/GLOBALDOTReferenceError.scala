...
object GLOBALDOTReferenceError extends Algorithm {
  val name: String = "GLOBALDOTReferenceError"
  val length: Int = 1
  val lang: Boolean = false
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.ReferenceError" (this, argumentsList, NewTarget) => {
