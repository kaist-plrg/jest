...
object GLOBALDOTPromiseDOTallSettled extends Algorithm {
  val name: String = "GLOBALDOTPromiseDOTallSettled"
  val length: Int = 1
  val lang: Boolean = false
  val func: Func = FixUIdWalker(parseFunc(""""GLOBAL.Promise.allSettled" (this, argumentsList, NewTarget) => {
    ...
    iteratorRecord
    app __x4__ = (PerformPromiseAllSettled iteratorRecord C promiseCapability)
    let result = __x4__
