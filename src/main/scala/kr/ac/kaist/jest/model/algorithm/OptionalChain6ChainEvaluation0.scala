...
object OptionalChain6ChainEvaluation0 extends Algorithm {
  val name: String = "OptionalChain6ChainEvaluation0"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""OptionalChain6ChainEvaluation0" (this, OptionalChain, IdentifierName, baseValue, baseReference) => {
