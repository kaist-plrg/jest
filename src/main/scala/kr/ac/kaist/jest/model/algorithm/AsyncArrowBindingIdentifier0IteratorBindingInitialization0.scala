...
object AsyncArrowBindingIdentifier0IteratorBindingInitialization0 extends Algorithm {
  val name: String = "AsyncArrowBindingIdentifier0IteratorBindingInitialization0"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""AsyncArrowBindingIdentifier0IteratorBindingInitialization0" (this, BindingIdentifier, iteratorRecord, environment) => {
