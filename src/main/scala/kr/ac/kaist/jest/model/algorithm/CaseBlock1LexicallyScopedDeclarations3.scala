...
object CaseBlock1LexicallyScopedDeclarations3 extends Algorithm {
  val name: String = "CaseBlock1LexicallyScopedDeclarations3"
  val length: Int = 0
  val lang: Boolean = true
  val func: Func = FixUIdWalker(parseFunc(""""CaseBlock1LexicallyScopedDeclarations3" (this, CaseClauses0, DefaultClause, CaseClauses1) => {
